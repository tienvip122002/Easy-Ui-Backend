        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkDisplayEmail = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Js = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UIComponents_AspNetUsers_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_UIComponents_AspNetUsers_UpdatedBy",
                        column: x => x.UpdatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Carts_UIComponents_UIComponentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Comments_UIComponents_ComponentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComponentCategories", x => new { x.CategoriesId, x.ComponentsId });
                    table.ForeignKey(
                        name: "FK_ComponentCategories_Categories_CategoriesId",
                        column: x => x.CategoriesId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ComponentCategories_UIComponents_ComponentsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComponentTags", x => new { x.ComponentsId, x.TagsId });
                    table.ForeignKey(
                        name: "FK_ComponentTags_Tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ComponentTags_UIComponents_ComponentsId",
                        column: x => x.ComponentsId,
                        principalTable: "UIComponents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItems_UIComponents_UIComponentId",
                        column: x => x.UIComponentId,
                        principalTable: "UIComponents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SavedByUsersId = table.Column<Guid>(type: "uuid", nullable: false),
                    SavedComponentsId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SavedComponents", x => new { x.SavedByUsersId, x.SavedComponentsId });
                    table.ForeignKey(
                        name: "FK_SavedComponents_AspNetUsers_SavedByUsersId",
                        column: x => x.SavedByUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SavedComponents_UIComponents_SavedComponentsId",
                        column: x => x.SavedComponentsId,
                        principalTable: "UIComponents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComponentCategories_ComponentsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_UIComponentId",
                table: "OrderItems",
                column: "UIComponentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedComponents_SavedComponentsId",
                table: "SavedComponents",
                column: "SavedComponentsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UIComponents_CreatedBy",
                table: "UIComponents",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_UIComponents_UpdatedBy",
                table: "UIComponents",
                column: "UpdatedBy");
